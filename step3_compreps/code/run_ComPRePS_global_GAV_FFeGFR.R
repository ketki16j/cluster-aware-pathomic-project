...
input.file.name <- file.path("/scratch/juno/kxj190026/others/jeremy/procurement-biopsy-pathomics-ml", "data/Renal_Data_FF_global_GAV_FFeGFR.csv")
...
folder_c   <- file.path(WORKDIR_ABS, "results/FF_compres/eGFR_FF_global_GAV_C")
folder_mse <- file.path(WORKDIR_ABS, "results/FF_compres/eGFR_FF_global_GAV_MSE")
