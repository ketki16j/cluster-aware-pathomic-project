...
input.file.name <- file.path("/scratch/juno/kxj190026/others/jeremy/procurement-biopsy-pathomics-ml", "data/Renal_Data_naive_T.csv")
...
folder_c   <- file.path(WORKDIR_ABS, "results/naive_compres/eGFR_naive_T_C")
folder_mse <- file.path(WORKDIR_ABS, "results/naive_compres/eGFR_naive_T_MSE")
